...
public class DeviceControlActivity extends Activity {
    ...
    public final String WeatherUUID = "00000002-0000-0000-fdfd-fdfdfdfdfdfd";
    ...
    private String getUUIDName(String uuid){
        ...
        }else if(uuid.equals(HUMIDITY_MEASUREMENT)){
            name = "Humidity Measurement";
        }else if(uuid.equals(WeatherUUID)){
            name = "BLE Weather";
        }else{
